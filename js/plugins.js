...
(function($, window, document, undefined) {
    ...
    OnePageNav.prototype = {
        ...
        scrollTo: function(target, callback) {
            ...
            var topbar = jQuery('.youssef_tm_header').outerHeight();
        ...
        e.prototype.maximum = function(a) {
            ...
            if (e.loop)
                ...
                for (b = this._items.length,
                    ...
                    d = this.$element.width(); b-- && (c += this._items[b].width() + this.settings.margin, !(c > d));)
                ;
                f = b + 1
            } else
            ...
            for (var r in t) {
                ...
                for (var a in this.waypoints[r]) {
                    ...
                    d.element !== d.element.window && (y = d.adapter.offset()[s.offsetProp]),
                        ...
                        u = h && p,
                        c = !h && !p, !g && u ? (d.queueTrigger(s.backward),
...
(function(e) {
        ...
        N = function(k, c) {
            ...
            function l(d, c, g) {
                ...
                return isNaN(d) ? (d = u[c] || 0,
                    g = 3 == d ? g ? b.win.outerHeight() - b.win.innerHeight() : b.win.outerWidth() - b.win.innerWidth() : 1,
                    b.isie8 && d && (d += 1),
                    g ? d : 0) : d
            }
            ...
            function n(d, c, g, e) {
                b._bind(d, c, function(b) {
                    ...
                    "mousewheel" == c ? (e.deltaY = -0.025 * b.wheelDelta,
                        b.wheelDeltaX && (e.deltaX = -0.025 * b.wheelDeltaX)) : e.deltaY = b.detail;
                    return g.call(d, e)
                }, e)
            }
            ...
            f.cantouch && (f.ismozilla && !f.isios) && (this.istouchcapable = !0,
                f.cantouch = !1);
            b.opt.enablemouselockapi || (f.hasmousecapture = !1,
                f.haspointerlock = !1);
            ...
            this.doRailClick = function(d, c, g) {
                ...
                b.locked || (b.cancelEvent(d),
                    c ? (c = g ? b.doScrollLeft : b.doScrollTop,
                        ...
                        c(f)) : (c = g ? b.doScrollLeftBy : b.doScrollBy,
            ...
            this.init = function() {
                ...
                if (!b.ispage || !f.cantouch && !f.isieold && !f.isie9mobile) {
                    ...
                    for (G in n)
                        k = n[G],
                        (l = b.opt.railpadding[k]) ? g.css("padding-" + k, l + "px") : b.opt.railpadding[k] = 0;
                    g.append(c);
                    ...
                    b.opt.boxzoom && (!b.ispage && !f.isieold) && (c = document.createElement("div"),
                        ...
                        f.cantouch && b.opt.gesturezoom && (b.ongesturezoom = function(d) {
                    ...
                    b.ispage ? (g.css({
                        ...
                        b.railh && (m.css({
                            ...
                            b.viewport && (b.body = b.viewport, !1 == /relative|absolute/.test(b.viewport.css("position")) && b.css(b.viewport, {
                                position: "relative"
                            })),
                            g.css({
                                position: d
                    ...
                    !1 === b.opt.autohidemode ? (b.autohidedom = !1,
                        ...
                        b.railh && b.railh.css({
                            opacity: b.opt.cursoropacitymax
                        })) : !0 === b.opt.autohidemode ? (b.autohidedom = e().add(b.rail),
                    ...
                    if (f.isie9mobile)
                        ...
                        b.onmangotouch = function(d) {
                            ...
                            if (0 != Math.round(Math.sqrt(Math.pow(f, 2) + Math.pow(g, 2)))) {
                                ...
                                80 < h - b.mangotouch.tm || b.mangotouch.dry != p || b.mangotouch.drx != e ? (b.scrollmom.stop(),
                            ...
                            b.ontouchend = function(d) {
                                ...
                                if (b.rail.drag && 2 == b.rail.drag.pt && (b.scrollmom.doMomentum(),
                                        ...
                                        b.hasmoving && (b.hasmoving = !1,
                                            b.lastmouseup = !0,
                                            b.hideCursor(),
                                            f.hasmousecapture && document.releaseCapture(), !f.cantouch)))
                                    return b.cancelEvent(d)
                            };
                            ...
                            b.ontouchmove = function(d, c) {
                                ...
                                if (b.rail.drag && 2 == b.rail.drag.pt) {
                                    ...
                                    var h = d.clientY + ofy,
                                        ...
                                        k = l - b.rail.drag.x,
                                        s = b.rail.drag.st - p;
                                    b.ishwscroll && b.opt.bouncescroll ? 0 > s ? s = Math.round(s / 2) : s > b.page.maxh && (s = b.page.maxh + Math.round((s - b.page.maxh) / 2)) : (0 > s && (h = s = 0),
                                        s > b.page.maxh && (s = b.page.maxh,
                                            h = 0));
                                    ...
                                    if (b.rail.drag.dl)
                                        ...
                                        if ("v" == b.rail.drag.ck) {
                                            ...
                                            k > n && (b.rail.drag.dl = "f",
                                                e("body").scrollTop(e("body").scrollTop()))
                                        } else if ("h" == b.rail.drag.ck) {
                                            if (k > n && p <= 0.3 * az)
                                                return b.rail.drag = !1, !0;
                                            p > n && (b.rail.drag.dl = "f",
                                    ...
                                    b.synched("touchmove", function() {
                                        b.rail.drag && 2 == b.rail.drag.pt && (b.prepareTransition && b.prepareTransition(0),
                                            ...
                                            b.railh && b.railh.scrollable ? (b.setScrollLeft(m),
                                                b.showCursor(s, m)) : b.showCursor(s),
                        ...
                        b.onmouseup = function(d) {
                            if (b.rail.drag && (f.hasmousecapture && document.releaseCapture(),
                        ...
                        if (f.cantouch || b.opt.touchbehavior)
                            ...
                            b.onclick = f.isios ? !1 : function(d) {
                        ...
                        !f.cantouch && !b.opt.touchbehavior ? (b.bind(f.hasmousecapture ? b.win : document, "mouseup", b.onmouseup),
                            ...
                            b.onclick && b.bind(document, "click", b.onclick), !b.ispage && b.opt.enablescrollonselection && (b.bind(b.win[0], "mousedown", b.onselectionstart),
                        ...
                        b.opt.enablemousewheel && (b.isiframe || b.bind(f.isie && b.ispage ? document : b.docscroll, "mousewheel", b.onmousewheel),
                ...
                if ("IFRAME" == this.doc[0].nodeName) {
                    var I = function(d) {
                        ...
                        !f.isios && (b.opt.iframeautoresize && !b.isiframe) && (b.win.scrollTop(0),
                            b.doc.height(""),
            ...
            this.onResize = function(d, c) {
                ...
                if (b.page.maxh == g && b.page.maxw == f && b.view.w == e) {
                    if (b.ispage)
                        return b;
                    g = b.win.offset();
                    if (b.lastposition && (f = b.lastposition,
                            f.top == g.top && f.left == g.left))
                        return b;
                    b.lastposition = g
                }
            ...
            this.bind = function(d, c, g, e) {
                ...
                "mousewheel" == c ? "onwheel" in b.win ? b._bind(h, "wheel", g, e || !1) : (d = "undefined" != typeof document.onmousewheel ? "mousewheel" : "DOMMouseScroll",
                    n(h, d, g, e || !1),
                    "DOMMouseScroll" == d && n(h, "MozMousePixelScroll", g, e || !1)) : h.addEventListener ? (f.cantouch && /mouseup|mousedown|mousemove/.test(c) && b._bind(h, "mousedown" == c ? "touchstart" : "mouseup" == c ? "touchend" : "touchmove", function(b) {
                        if (b.touches) {
                    ...
                    b._bind(h, c, g, e || !1),
                    f.cantouch && "mouseup" == c && b._bind(h, "touchcancel", g, e || !1)) : b._bind(h, c, function(d) {
                ...
                this.doScrollPos = function(c, e, g) {
                    ...
                    b.timer = setTimeout(function() {
                        ...
                        0 < l && (!b.scrollrunning && b.onscrollstart && b.onscrollstart.call(b, {
                            ...
                            f.transitionend ? b.scrollendtrapped || (b.scrollendtrapped = !0,
                                b.bind(b.doc, f.transitionend, b.onScrollEnd, !1)) : (b.scrollendtrapped && clearTimeout(b.scrollendtrapped),
            ...
            this.doZoomIn = function(c) {
                if (!b.zoomactive) {
                    ...
                    f.isios4 && (b.zoomrestore.scrollTop = e(window).scrollTop(),
                ...
                if (c.speedy && k && c.speedy || e) {
                    ...
                    var r = c.lastscrollx,
                        ...
                        d = function() {
                            ...
                            if (c.speedx && (r = Math.floor(c.lastscrollx - c.speedx * (1 - c.demulxy)),
                                    c.lastscrollx = r,
                                    0 > r || r > q))
                                e = 0.1;
                            ...
                            1 > c.demulxy ? c.timer = setTimeout(d, f) : (c.stop(),
                                c.nc.hideCursor(),
                                c.doSnapy(r, u))
                        };
                    d()
    ...
    e.nicescroll || (e.nicescroll = new C,
        e.nicescroll.options = F)
})(jQuery);
...
! function(e) {
    ...
    var t, n, i, o, r, a, s = "Close",
        ...
        _ = function() {
            e.magnificPopup.instance || (t = new C,
                t.init(),
    ...
    C.prototype = {
            ...
            open: function(n) {
                ...
                k("BeforeOpen"),
                    t.st.showCloseBtn && (t.st.closeBtnInside ? (I(u, function(e, t, n, i) {
            ...
            close: function() {
                t.isOpen && (k(l),
                    t.isOpen = !1,
                    t.st.removalDelay && !t.isLowIE && t.supportsTransition ? (t._addClassToMFP(h),
                        setTimeout(function() {
                            t._close()
    ...
    e.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            ...
            _getOffset: function(n) {
                ...
                return W() ? s["-moz-transform"] = s.transform = "translate(" + o.left + "px," + o.top + "px)" : (s.left = o.left,
                        s.top = o.top),
                    s
            }
        }
                ...
                initRetina: function() {
                    if (window.devicePixelRatio > 1) {
                        var e = t.st.retina,
                            n = e.ratio;
                        n = isNaN(n) ? n() : n,
                            n > 1 && (I("ImageHasSize." + U, function(e, t) {
                                    t.img.css({
            ...
            var s = function() {
                ...
                c = function() {
                    ...
                    if (i || t(this).append('<div class="js-tilt-glare"><div class="js-tilt-glare-inner"></div></div>'),
                        ...
                        this.glareElement = t(this).find(".js-tilt-glare-inner"), !i) {
                        var s = {
                            position: "absolute",
                            top: "0",
                            left: "0",
    ...
    a.waitForImages = {
        ...
        a.fn.waitForImages = function() {
            var d, e, f, g = 0,
                ...
                n = /url\(\s*(['"]?)(.*?)\1\s*\)/g;
            if (a.isPlainObject(arguments[0]) ? (f = arguments[0].waitForAll,
                    e = arguments[0].each,
                ...
                d = d || a.noop,
                e = e || a.noop,
                f = !!f, !a.isFunction(d) || !a.isFunction(e))
